...
assert test.fix(0.51820793533883979, 0) == 1;
assert test.fix(0.51820793533883979, 1) == 0.5;
assert test.fix(0.51820793533883979, 2) == 0.52;
assert test.fix(0.51820793533883979, 3) == 0.518;
assert test.fix(0.51820793533883979, 16) == 0.5182079353388398;
assert test.fix(0.51820793533883979, 17) == 0.51820793533883980;
assert test.fix(0.51820793533883979, 20) == 0.5182079353388398;
